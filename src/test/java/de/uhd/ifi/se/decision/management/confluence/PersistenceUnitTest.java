...
public class PersistenceUnitTest {
	...
	public void testCheckData() {
		...
		ArrayList<ArrayList<DecisionKnowledgeElement>> elements = keeping.getElementsGroupedFromPageIdAndMacroId(pageId,
				macroId);
