...
public class DecisionKnowledgeImportMacro implements Macro {
	...
	public String execute(Map<String, String> map, String s, ConversionContext conversionContext)
		...
		pageBuilderService.assembler().resources()
				.requireWebResource("de.uhd.ifi.se.decision.macro:myConfluenceMacro-resources");
		...
		if (map.get("yourJsonArray") != null) {
			...
			// JSONArray children =
			// myObj.getJSONObject("nodeStructure").getJSONArray("children");
	...
	public String generateTableRow(JSONObject myObject) {
		...
		return "<tr>" + "<td><a target='_blank' href='" + myLinkToJira + "'>" + myKey + "</a></td>" + "<td>"
				+ myIssueType + "</td>"
				// + "<td>" + myStatus + "</td>"
				// + "<td>" + myPriority + "</td>"
				// + "<td>" + myAssignee + "</td>"
				+ "<td>" + mySummary + "</td>" + "<td>" + myDescription + "</td>" + "</tr>";

	}

	public String generateTableHeader() {
		return "<tr>" + "<th>Id</th>" + "<th>Issue Type</th>" +
		// "<th>Status</th>" +
		// "<th>Priority</th>" +
		// "<th>Assignee</th>" +
				"<th>Summary</th>" + "<th>Description</th>" + "</tr>";
	}
